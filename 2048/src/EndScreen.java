...
public class EndScreen extends JFrame { //class for highscore window
	...
	public static EndScreen newpage;
	...
	public EndScreen() {
        ...
        for (int i = scores.size()-1; i >= Math.max(scores.size()-7, 0); i--) //only displays the top 5 scores for that difficulty
		{
			...
			lblNewLabel1.setBounds(30, 400 + (scores.size() - 1 - i) * 35, 300, 29);
